...
const ContactSection = () => {
  return (
    <div className="relative pb-40">
      <div className="bottom-0 left-0 z-0 hidden xl:absolute">
        <Image src={artBg} alt="bg" />
      </div>
      <section className="bg-contact-texture relative mx-auto w-11/12 max-w-screen-xl">
        <div className="relative z-10 space-y-16">
          <h2 className="text-center text-6xl font-bold">Get in Touch</h2>
          ...
          <div className="grid grid-cols-1 gap-[30px] md:grid-cols-2">
            <div className="space-y-8">
              ...
              <div className="rounded-4xl bg-gradient-to-r from-[#191A1B] to-[#131415] px-10 py-8">
                <div className="flex items-center gap-[30px]">
                  <HiOutlineMailOpen className="text-lightYellow h-10 w-10" />

                  <div>
                    <h4 className="text-2xl font-bold">Email</h4>
                    <Link
                      href="mailto:contact@jamescryptoguru.com"
                      className="yellow-gradient-text text-lg font-semibold"
                    >
