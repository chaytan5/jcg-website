  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast:
            "group toast group-[.toaster]:shadow-md group-[.toaster]:shadow-neutral-900 group-[.toaster]:dark-gray-gradient group-[.toaster]:text-neutral-50 group-[.toaster]:border-neutral-800",
          description:
